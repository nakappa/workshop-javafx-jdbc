...
public class SellerListController implements Initializable, DataChangeListener {
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		try {
			...
			dialogStage.setResizable(false); // serve para permitir ou não permitir que a janela seja redimensionada.
			dialogStage.initOwner(parentStage); // serve para identificar o Stage pai da janela.
			dialogStage.initModality(Modality.WINDOW_MODAL); // serve para travar a janela enquanto não fechar ela.
	...
	private void initializeNodes() {
		...
		Stage stage = (Stage) Main.getMainScene().getWindow(); // serve para pegar a referência da janela.
		tableViewSeller.prefHeightProperty().bind(stage.heightProperty()); // serve para acompanhar a altura da janela.
	}
